...
| VS Code | Wenn Sie versuchen, Visual Studio Live Share mit vs Code unter macOS <strong>El Capitan oder</strong>niedriger zu verwenden, tritt ein Fehler auf. | Die Betriebssystemunterstützung von Visual Studio Live Share ist von .net Core abhängig [und unterstützt derzeit nur macOS Sierra und aufwärts](https://github.com/dotnet/core/blob/master/release-notes/2.0/2.0-supported-os.md). |
...
| Tool | Problem | Wahrscheinliche Ursache |
|------|------|----------------|
